...
export class Controls {
        ...
        <div class="control-content">
          ...
          <section class="control-section">
            ...
            <div class="control-group">
              <label>Repeats: <span id="repeats-value">${
                this.settings.repeats
              }</span></label>
              <input type="range" id="repeats" min="1" max="128" step="1" value="${
                this.settings.repeats
              }" />
            </div>

            <div class="control-group">
              <label>Size: <span id="size-value">${
                this.settings.size
              }px</span></label>
              <input type="range" id="size" min="10" max="500" value="${
                this.settings.size
              }" />
            </div>

            <div class="control-group">
              <label>Radius: <span id="radius-value">${
                this.settings.radius
              }px</span></label>
              <input type="range" id="radius" min="0" max="500" value="${
                this.settings.radius
              }" />
            </div>
            ...
            <div class="control-group">
              ...
              <div class="radio-group">
                <label><input type="radio" name="compDir" value="ccw" ${
                  this.settings.compDirection === 'ccw' ? 'checked' : ''
                } /> CCW</label>
                <label><input type="radio" name="compDir" value="cw" ${
                  this.settings.compDirection === 'cw' ? 'checked' : ''
                } /> CW</label>
              </div>
              <input type="range" id="compSpeed" min="0" max="0.1" step="0.001" value="${
                this.settings.compSpeed
              }" />
              <span id="compSpeed-value">${this.settings.compSpeed.toFixed(
                3
              )}</span>
            </div>
            ...
            <div class="control-group">
              ...
              <div class="radio-group">
                <label><input type="radio" name="indDir" value="ccw" ${
                  this.settings.indDirection === 'ccw' ? 'checked' : ''
                } /> CCW</label>
                <label><input type="radio" name="indDir" value="cw" ${
                  this.settings.indDirection === 'cw' ? 'checked' : ''
                } /> CW</label>
              </div>
              <input type="range" id="indSpeed" min="0" max="0.2" step="0.001" value="${
                this.settings.indSpeed
              }" />
              <span id="indSpeed-value">${this.settings.indSpeed.toFixed(
                3
              )}</span>
            </div>
          </section>
          ...
          <section class="control-section">
            ...
            <label class="checkbox-label">
              <input type="checkbox" id="radialOrientationEnabled" ${
                this.settings.radialOrientationEnabled ? 'checked' : ''
              } />
              Enable Radial Orientation
            </label>

            <div class="control-group">
              <label>Orientation Angle: <span id="radialOrientationOffset-value">${Math.round(
                (this.settings.radialOrientationOffset * 180) / Math.PI
              )}°</span></label>
              <input type="range" id="radialOrientationOffset" min="${-Math.PI}" max="${
      Math.PI
    }" step="0.01" value="${this.settings.radialOrientationOffset}" />
            </div>
            ...
            <div class="preset-buttons" style="display: grid; grid-template-columns: 1fr 1fr; gap: 8px; margin-top: 12px;">
              ...
              <button class="preset-btn" data-angle="${
                Math.PI
              }" style="padding: 8px; border: 1px solid #0f0; background: rgba(0,255,0,0.1); color: #0f0; border-radius: 4px; cursor: pointer; font-size: 11px;">Point Inward</button>
              <button class="preset-btn" data-angle="${
                Math.PI / 2
              }" style="padding: 8px; border: 1px solid #0f0; background: rgba(0,255,0,0.1); color: #0f0; border-radius: 4px; cursor: pointer; font-size: 11px;">Tangent CW</button>
              <button class="preset-btn" data-angle="${
                -Math.PI / 2
              }" style="padding: 8px; border: 1px solid #0f0; background: rgba(0,255,0,0.1); color: #0f0; border-radius: 4px; cursor: pointer; font-size: 11px;">Tangent CCW</button>
            </div>
          </section>
          ...
          <section class="control-section">
            ...
            <label class="checkbox-label">
              <input type="checkbox" id="scaleToggle" ${
                this.settings.scaleToggle ? 'checked' : ''
              } />
              Enable Scale Pulsation
            </label>

            <div class="control-group">
              <label>Rate: <span id="scaleRate-value">${this.settings.scaleRate.toFixed(
                3
              )}</span></label>
              <input type="range" id="scaleRate" min="0" max="0.2" step="0.001" value="${
                this.settings.scaleRate
              }" />
            </div>

            <div class="control-group">
              <label>Amount: <span id="scaleAmt-value">${this.settings.scaleAmt.toFixed(
                2
              )}</span></label>
              <input type="range" id="scaleAmt" min="0" max="1" step="0.01" value="${
                this.settings.scaleAmt
              }" />
            </div>

            <label class="checkbox-label">
              <input type="checkbox" id="perItemScale" ${
                this.settings.perItemScale ? 'checked' : ''
              } />
          ...
          <section class="control-section">
            ...
            <label class="checkbox-label">
              <input type="checkbox" id="radialToggle" ${
                this.settings.radialToggle ? 'checked' : ''
              } />
              Enable Radial Oscillation
            </label>

            <div class="control-group">
              <label>Rate: <span id="radialRate-value">${this.settings.radialRate.toFixed(
                3
              )}</span></label>
              <input type="range" id="radialRate" min="0" max="0.2" step="0.001" value="${
                this.settings.radialRate
              }" />
            </div>

            <div class="control-group">
              <label>Amount: <span id="radialAmt-value">${
                this.settings.radialAmt
              }px</span></label>
              <input type="range" id="radialAmt" min="0" max="200" step="1" value="${
                this.settings.radialAmt
              }" />
            </div>

            <label class="checkbox-label">
              <input type="checkbox" id="perItemRadial" ${
                this.settings.perItemRadial ? 'checked' : ''
              } />
              Individual Variation
            </label>
          </section>
          ...
          <section class="control-section">
            ...
            <div class="control-group">
              ...
              <input type="color" id="bgColor" value="${
                this.settings.bgColor
              }" />
            </div>

            <label class="checkbox-label">
              <input type="checkbox" id="hueMode" ${
                this.settings.hueMode ? 'checked' : ''
              } />
              Hue Rotation
            </label>

            <div class="control-group">
              <label>Hue Drift: <span id="hueDriftSpeed-value">${this.settings.hueDriftSpeed.toFixed(
                2
              )}</span></label>
              <input type="range" id="hueDriftSpeed" min="-2" max="2" step="0.01" value="${
          ...
          <section class="control-section">
            ...
            <label class="checkbox-label">
              <input type="checkbox" id="filterEnabled" ${
                this.settings.filterEnabled ? 'checked' : ''
              } />
              Enable Filters
            </label>

            <div class="control-group">
              <label>Brightness: <span id="brightness-value">${
                this.settings.brightness
              }%</span></label>
              <input type="range" id="brightness" min="0" max="200" value="${
                this.settings.brightness
              }" />
            </div>

            <div class="control-group">
              <label>Contrast: <span id="contrast-value">${
                this.settings.contrast
              }%</span></label>
              <input type="range" id="contrast" min="0" max="200" value="${
                this.settings.contrast
              }" />
            </div>

            <div class="control-group">
              <label>Saturation: <span id="saturation-value">${
                this.settings.saturation
              }%</span></label>
              <input type="range" id="saturation" min="0" max="200" value="${
                this.settings.saturation
              }" />
            </div>

            <div class="control-group">
              <label>Blur: <span id="blur-value">${
                this.settings.blur
              }px</span></label>
              <input type="range" id="blur" min="0" max="10" step="0.1" value="${
                this.settings.blur
              }" />
            </div>
          </section>
          ...
          <section class="control-section">
            ...
            <label class="checkbox-label">
              <input type="checkbox" id="audioReactive" ${
                this.settings.audioReactive ? 'checked' : ''
              } />
              Enable Audio Reactivity
            </label>

            <div class="control-group">
              <label>Sensitivity: <span id="audioSens-value">${this.settings.audioSens.toFixed(
                1
              )}</span></label>
              <input type="range" id="audioSens" min="0" max="5" step="0.1" value="${
                this.settings.audioSens
              }" />
            </div>

            <div class="control-group">
              <label>Bass Boost: <span id="bassBoost-value">${this.settings.bassBoost.toFixed(
                1
              )}</span></label>
              <input type="range" id="bassBoost" min="0" max="5" step="0.1" value="${
                this.settings.bassBoost
              }" />
            </div>

            <div class="control-group">
              <label>Mid Boost: <span id="midBoost-value">${this.settings.midBoost.toFixed(
                1
              )}</span></label>
              <input type="range" id="midBoost" min="0" max="5" step="0.1" value="${
                this.settings.midBoost
              }" />
            </div>

            <div class="control-group">
              <label>Treble Boost: <span id="trebBoost-value">${this.settings.trebBoost.toFixed(
                1
              )}</span></label>
              <input type="range" id="trebBoost" min="0" max="5" step="0.1" value="${
                this.settings.trebBoost
              }" />
            </div>

            <div class="control-group">
              <label>Max Radius Mod: <span id="audioModMax-value">${
                this.settings.audioModMax
              }px</span></label>
              <input type="range" id="audioModMax" min="0" max="500" step="10" value="${
                this.settings.audioModMax
              }" />
            </div>
          </section>
  ...
  private renderExamples(): void {
    ...
    grid.innerHTML = examples
      .map(
        (ex) => `
        <button class="example-btn" data-file="${ex.file}" data-label="${
          ex.label
        }" data-preset="${ex.presetUrl || ''}">
          ${ex.label}
        </button>
      `
      )
  ...
  private attachEventListeners(): void {
    ...
    this.container
      .querySelector('#uploadSettingsBtn')
      ?.addEventListener('click', () => {
        const fileInput = this.container.querySelector(
          '#uploadSettings'
        ) as HTMLInputElement
    ...
    const uploadInput = this.container.querySelector(
      '#uploadSettings'
    ) as HTMLInputElement
  ...
  private updateFileInfo(filename: string): void {
    const uploadPrompt = this.container.querySelector(
      '#uploadPrompt'
    ) as HTMLElement
